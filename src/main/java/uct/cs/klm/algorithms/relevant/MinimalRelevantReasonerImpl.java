...
public class MinimalRelevantReasonerImpl extends KlmReasonerBase implements IReasonerService {
    ...
    public ModelEntailment getEntailment(
       ...
       // var relevantCorrectKb = relevanceResult.getCorrectRelevantKb();
        ...
        _logger.debug("RPlus: {}", relevanceResult.getRelevantKb());
        _logger.debug("RCorrect: {}", relevanceResult.getCorrectRelevantKb());
        
        _logger.debug("R-Plus: {}", relevanceResult.getIrrelevantRanking().getKnowledgeBase());
        _logger.debug("R-Correct: {}",  relevanceResult.getCorrectIrrelevantRanking().getKnowledgeBase());
     ...
     private RelevanceResult GetRelevantRanks(
        ...
        IJustificationService justification = ReasonerFactory.createJustification(ReasonerType.MinimalRelevantClosure);
